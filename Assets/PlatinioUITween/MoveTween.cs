...
namespace PlatinioUITweeen
{
    ...
    {        
        [SerializeField] private List<RectTransform> m_path = null;
        ...
        public List<RectTransform> Path { get{ return m_path; } }
        ...
        private void Awake()
        {
            ...
            nodeRect.anchoredPosition = m_rectTransform.anchoredPosition;

            m_path.Insert(0 , node.GetComponent<RectTransform>());
